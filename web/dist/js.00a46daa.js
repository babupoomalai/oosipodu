    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return fetch("".concat(baseURL, "/auth/validateMobileOtp"), {
              method: 'post',
              headers: {
                'Content-Type': 'application/json'
              },
              body: JSON.stringify({
                txnId: id,
                otp: CryptoJS.SHA256(otp).toString() // otp: await sha256(otp)
...
function () {
  var _ref5 = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee5(mobile, isIn) {
    var result;
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
    ...
    computed: {
      ...
      isVaccinated: function isVaccinated() {
        ...
        if (!isVaccinated) {
          ...
          isVaccinated = _.find(beneficiaries, function (person) {
        ...
        return isVaccinated; // return this.user.dbuser.cnt > 0;
      },
    ...
    methods: {
      updateTokenExpiry: function updateTokenExpiry() {
        ...
        setInterval(function () {
          if (_this3.authenticatedAt) {
            var seconds = Math.floor((_this3.authenticatedAt - Date.now() + 15 * 60 * 1000) / 1000);
            var minutes = Math.floor(seconds / 60);
            if (seconds <= 0) _this3.logout();
            if (minutes !== 0) _this3.user.tokenExpiry = "~".concat(minutes, "m");else _this3.user.tokenExpiry = "".concat(seconds, "s");
          }
        }, 1000);
      },
            ...
            while (1) {
              switch (_context4.prev = _context4.next) {
                ...
                case 2:
                  ...
                  this.user.dbUser = dbUser; // Existence of entry means vaccinated
      ...
      fetchCoupons: function () {
        var _fetchCoupons = _asyncToGenerator(
        /*#__PURE__*/
            ...
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  ...
                  _context5.next = 3;
                  return userService.getCoupons(this.store);

                case 3:
                  this.coupons = _context5.sent;
        ...
        function fetchCoupons() {
          return _fetchCoupons.apply(this, arguments);
        }

        return fetchCoupons;
      }(),
      fetchBeneficiaries: function () {
        var _fetchBeneficiaries = _asyncToGenerator(
        /*#__PURE__*/
        regeneratorRuntime.mark(function _callee6(dbUser) {
          var beneficiaries;
        ...
        function fetchBeneficiaries(_x) {
          return _fetchBeneficiaries.apply(this, arguments);
        }
            ...
            while (1) {
              switch (_context7.prev = _context7.next) {
                ...
                case 2:
                  ...
                  return _context7.abrupt("return", this.user.beneficiaries);
      ...
      showOptIn: function showOptIn() {
        $('#optedOut').addClass('d-none');
        $('#optedIn').removeClass('d-none');
      },
      optIn: function () {
        var _optIn = _asyncToGenerator(
        /*#__PURE__*/
          ...
          return regeneratorRuntime.wrap(function _callee10$(_context10) {
            while (1) {
              switch (_context10.prev = _context10.next) {
                case 0:
                  _context10.next = 2;
                  return userService.optIn(this.mobile, true);
      ...
      optOut: function () {
          ...
          return regeneratorRuntime.wrap(function _callee11$(_context11) {
            while (1) {
              switch (_context11.prev = _context11.next) {
                case 0:
                  _context11.next = 2;
                  return userService.optIn(this.mobile, false);
        ...
        function optOut() {
          return _optOut.apply(this, arguments);
        }

        return optOut;
      }(),
      isOptIn: function isOptIn() {
